...
readTextFile("./config.json", function (text) {
    ...
    socket_url = config['serverAddress'];
    port = config['port'];
});
...
function openSocket() {
    ...
    webSocket = new WebSocket("ws://" + socket_url + ":" + port + "/ChatAppServer/chat?name=" + name);
...
function parseMessage(message) {
    ...
    if (jObj.flag == 'self') {
        ...
        $('p.online_count').html(
            'Hello, <span class="blue">' + name + '</span>. <b>'
 ...
 * Created by Wojciech on 24.05.2017.
 */
